...
#define CMD_PROC_ALLOC_HINTED   0xBDAA000E
...
#define CMD_PROC_SCAN_AOB       0xBDAA0501
#define CMD_PROC_SCAN_AOB_MULTI 0xBDAA0502
#define CMD_PROC_AUTH           0xBDAACCFF
#define CMD_PROC_SCAN_START     0xBDAACC01
#define CMD_PROC_SCAN_COUNT     0xBDAACC02
#define CMD_PROC_SCAN_GET       0xBDAACC03
#define CMD_PROC_NOP            0xBDAACC06

#define CMD_DEBUG_ATTACH            0xBDBB0001
#define CMD_DEBUG_DETACH            0xBDBB0002
#define CMD_DEBUG_SET_BREAKPOINT    0xBDBB0003
#define CMD_DEBUG_SET_WATCHPOINT    0xBDBB0004
#define CMD_DEBUG_GET_THREAD_LIST   0xBDBB0005
#define CMD_DEBUG_SUSPEND_THREAD    0xBDBB0006
#define CMD_DEBUG_RESUME_THREAD     0xBDBB0007
...
#define CMD_DEBUG_GETDBREGS         0xBDBB000C
#define CMD_DEBUG_SETDBREGS         0xBDBB000D
#define CMD_DEBUG_CONTINUE          0xBDBB0010
#define CMD_DEBUG_THREAD_INFO       0xBDBB0011
#define CMD_DEBUG_STEP              0xBDBB0012
#define CMD_DEBUG_STEP_THREAD       0xBDBB0013

#define CMD_DEBUG_PROCESS_STOP      0xBDBB0500
...
#define CMD_PROC_SCAN_START_PACKET_SIZE 23
...
#define CMD_PROC_SCAN_AOB_PACKET_SIZE 22
...
#define CMD_PROC_SCAN_AOB_MULTI_PACKET_SIZE 21

struct cmd_proc_auth_packet {
    uint32_t magic;
    uint32_t flags;
} __attribute__((packed));
#define CMD_PROC_AUTH_PACKET_SIZE  8
#define CMD_PROC_AUTH_MAGIC        0xBB40E64D

struct cmd_proc_scan_get_packet {
    uint32_t pid;
    uint32_t count;
} __attribute__((packed));
#define CMD_PROC_SCAN_GET_PACKET_SIZE 8
...
#define CMD_PROC_ALLOC_HINTED_PACKET_SIZE 16
...
#define CMD_DEBUG_ATTACH_PACKET_SIZE 8
